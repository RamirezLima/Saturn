...
public class Cadastro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_Cadastrese1 = new javax.swing.JButton();
        ...
        jPanel2.add(btn_Cadastrese, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 240, 290, 40));

        btn_Cadastrese1.setBackground(new java.awt.Color(45, 118, 232));
        btn_Cadastrese1.setForeground(new java.awt.Color(255, 255, 255));
        btn_Cadastrese1.setText("Cadastrar");
        btn_Cadastrese1.setBorder(null);
        btn_Cadastrese1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_Cadastrese1ActionPerformed(evt);
            }
        });
        jPanel2.add(btn_Cadastrese1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 190, 290, 40));
...
int xx, xy;
    ...
    private void btn_Cadastrese1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Cadastrese1ActionPerformed
        // TODO add your handling code here:
        ...
        try{
            if (dao.Cadastro.cadastrarUsuario(usuario)){
    ...
    }//GEN-LAST:event_btn_Cadastrese1ActionPerformed
    ...
    private javax.swing.JButton btn_Cadastrese1;

...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(loginButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 190, 140, 40));
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        try{
            if (dao.Validar.valida(usuario)){
                ...
                String result = dao.Validar.dados(usuario); //chama metodo valiada dados e armazena id do usuario

    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try{
            if (dao.ValidarDAO.valida(usuario)){
                ...
                int result = dao.ValidarDAO.dados(usuario.getNome()); //chama metodo valiada dados e armazena id do usuario
                ...
                this.dispose(); 
                 ...
                 //chama metodo valiada dados e armazena id do usuario
